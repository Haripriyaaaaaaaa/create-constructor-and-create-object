...
output
Enter the coordinates of a first point P1(x1,y1,z1): 6 7 8
Enter the coordinates of a second point P2(x2,y2,z2): 9 2 3
Distance from origin to P1: 12.206555615733702
Distance from origin to P2: 9.695359714832659
Distance from P1 to P2: 7.681145747868608
